...
using VKR_Russkin.Services;

namespace VKR_Russkin.Controllers;
...
public class HomeController : Controller
{
    ...
    private void PopulateCatalogs(CalcViewModel model)
    {
        ...
        model.KinematicViscosityCatalog = _context.KVoAs
            .OrderBy(x => x.GasTemperature)
            .Select(x => new KinematicViscosityCatalogItemViewModel
            {
                GasTemperature = x.GasTemperature,
                KinematicViscosity = x.KinematicViscosity
            })
            .ToList();
